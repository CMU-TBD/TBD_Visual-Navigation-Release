...
from params.planner_params import create_params
...
def test_planner():
    ...
    c_p = create_params()
    # controller = ControlPipelineV0(c_p)
    # controller._load_control_pipeline()
    planner_params = create_params()
    ...
    obj_val, [waypts, horizons, trajectories_lqr, trajectories_spline, controllers] = planner.eval_objective(start_config, goal_config)
